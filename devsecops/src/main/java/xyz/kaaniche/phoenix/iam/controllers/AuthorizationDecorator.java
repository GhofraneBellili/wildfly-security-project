...
public abstract class AuthorizationDecorator<E extends RootEntity<ID>,ID extends java.io.Serializable> {
    @Any @Inject @Delegate
    ...
    private static final class Permission<E, ID> extends java.security.Permission {
